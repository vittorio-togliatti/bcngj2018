...
var mapa1 =
    ...
    "5, ,2,2,2, ,3,2,0,2,2,0,2,0,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,3,2,2,2,2,2,0,5\n" +
    "5, ,2,2,2, ,3,2,0,2,2,0,2,0,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,3,2,2,2,2,2,0,5\n" +
    "5, ,2,2,2, ,3,2,1,0,0,1,0,1,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,3,2,2,2,2,2,0,5\n" +
    ...
    this.game.physics.p2.gravity.y = 0;
        ...
        for(y=0;y<mapaJson.mapa.length;y++){
              for (x=0;x<mapaJson.mapa[y].length;x++){
                  if (mapaJson.mapa[y][x] == 2){
                    tile = this.game.add.sprite(x * 60 +30, y * 60 +30, 'fondos', 2);
                    this.game.physics.p2.enable(tile);
                    tile.body.static = true;
                  } else if(mapaJson.mapa[y][x] == 3){
                    tile = this.game.add.sprite(x * 60 +30, y * 60 +30, 'fondos', 3);
                    this.game.physics.p2.enable(tile);
                    tile.body.static = true;
                  }
